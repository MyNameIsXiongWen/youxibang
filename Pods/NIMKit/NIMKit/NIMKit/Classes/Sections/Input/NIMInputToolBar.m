...
- (void)update:(NIMInputStatus)status
{
    ...
    else if(status == NIMInputStatusMore)
    {
        [self.recordButton setHidden:YES];
        [self.inputTextView setHidden:NO];
        [self.inputTextBkgImage setHidden:NO];
...
{
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"]:[UIImage nim_imageInKit:@"icon_toolview_voice_normal"] forState:UIControlStateNormal];
...
{
    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"]:[UIImage nim_imageInKit:@"icon_toolview_emotion_normal"] forState:UIControlStateNormal];
...
- (void)updateMoreBtnImages:(BOOL)selected
{
    [self.moreMediaBtn setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"]:[UIImage nim_imageInKit:@"icon_toolview_add_normal"] forState:UIControlStateNormal];
    [self.moreMediaBtn setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_add_pressed"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
}
