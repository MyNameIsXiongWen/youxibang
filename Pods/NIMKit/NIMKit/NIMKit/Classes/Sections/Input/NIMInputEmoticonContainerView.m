...
- (void)loadUIComponents
{
    ...
    [_emotPageController addTarget:self action:@selector(pageControlValueChange) forControlEvents:UIControlEventValueChanged];
    [_emotPageController setUserInteractionEnabled:YES];
    [self addSubview:_emotPageController];
}

- (void)pageControlValueChange {
    [self.emoticonPageView scrollToPage:self.emotPageController.currentPage];
}
