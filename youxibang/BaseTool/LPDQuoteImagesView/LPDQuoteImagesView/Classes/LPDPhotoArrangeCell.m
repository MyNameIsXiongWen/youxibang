...
//        _imageThumbnail.layer.borderWidth = 2;
        ...
        [_videoThumbnail setImage:[UIImage imageNamedFromLPDBundle:@"LPDVideoPreviewPlay"]];
...
- (void)setupDeleteBtn:(CGFloat)width {
    ...
    [_nookDeleteBtn setImage:[UIImage imageNamedFromLPDBundle:@"nookDeleteBtn"] forState:UIControlStateNormal];
}
