...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:[UIImage imageNamedFromLPDBundle:@"navi_back.png"] forState:UIControlStateNormal];
    [_backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_backButton addTarget:self action:@selector(backButtonClick) forControlEvents:UIControlEventTouchUpInside];
    
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.lpd_width - 54, 10, 42, 42)];
    [_selectButton setImage:[UIImage imageNamedFromLPDBundle:lpdImagePickerVc.photoDefImageName] forState:UIControlStateNormal];
    [_selectButton setImage:[UIImage imageNamedFromLPDBundle:lpdImagePickerVc.photoSelImageName] forState:UIControlStateSelected];
...
- (void)configBottomToolBar {
    ...
    if (_lpdImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage imageNamedFromLPDBundle:_lpdImagePickerVc.photoPreviewOriginDefImageName] forState:UIControlStateNormal];
        [_originalPhotoButton setImage:[UIImage imageNamedFromLPDBundle:_lpdImagePickerVc.photoOriginSelImageName] forState:UIControlStateSelected];
    ...
    _numberImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamedFromLPDBundle:_lpdImagePickerVc.photoNumberIconImageName]];
