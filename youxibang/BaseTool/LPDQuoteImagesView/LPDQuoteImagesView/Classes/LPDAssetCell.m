...
- (void)setModel:(LPDAssetModel *)model {
    ...
    self.selectImageView.image = self.selectPhotoButton.isSelected ? [UIImage imageNamedFromLPDBundle:self.photoSelImageName] : [UIImage imageNamedFromLPDBundle:self.photoDefImageName];
...
- (void)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.selectImageView.image = sender.isSelected ? [UIImage imageNamedFromLPDBundle:self.photoSelImageName] : [UIImage imageNamedFromLPDBundle:self.photoDefImageName];
...
- (UIImageView *)viewImgView {
    if (_viewImgView == nil) {
        ...
        [viewImgView setImage:[UIImage imageNamedFromLPDBundle:@"VideoSendIcon.png"]];
...
- (UIImageView *)arrowImageView {
    if (_arrowImageView == nil) {
        ...
        [arrowImageView setImage:[UIImage imageNamedFromLPDBundle:@"TableViewArrow.png"]];
