...
- (void)configPlayButton {
    ...
    [_playButton setImage:[UIImage imageNamedFromLPDBundle:@"LPDVideoPreviewPlay.png"] forState:UIControlStateNormal];
    [_playButton setImage:[UIImage imageNamedFromLPDBundle:@"LPDVideoPreviewPlayHL.png"] forState:UIControlStateHighlighted];
