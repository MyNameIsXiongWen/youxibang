...
- (void)configBottomToolBar {
    ...
    if (lpdImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage imageNamedFromLPDBundle:lpdImagePickerVc.photoOriginDefImageName] forState:UIControlStateNormal];
        [_originalPhotoButton setImage:[UIImage imageNamedFromLPDBundle:lpdImagePickerVc.photoOriginSelImageName] forState:UIControlStateSelected];
    ...
    _numberImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamedFromLPDBundle:lpdImagePickerVc.photoNumberIconImageName]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (((lpdImagePickerVc.sortAscendingByModificationDate && indexPath.row >= _models.count) || (!lpdImagePickerVc.sortAscendingByModificationDate && indexPath.row == 0)) && _showTakePhotoBtn) {
        ...
        cell.imageView.image = [UIImage imageNamedFromLPDBundle:lpdImagePickerVc.takePictureImageName];
        return cell;
    }
