...
#define ScrollItemTime 0.1f
#define ScrollIntervalTime 2.f
...
- (void)scrollWithNoSpaceByDirection:(NSNumber *)direction{
    ...
    // 处于当前页面
        ...
        [UIView animateWithDuration:ScrollItemTime animations:^{
            ...
            if (_needStop == NO) {
                [self performSelector:@selector(scrollWithNoSpaceByDirection:) withObject:direction afterDelay:ScrollIntervalTime];
            }else{
                _isRunning = NO;
            }
        }];
    ...
    // 处于当前页面
        ...
        [UIView animateWithDuration:ScrollItemTime animations:^{
            ...
            [UIView animateWithDuration:ScrollItemTime animations:^{
                ...
                if (_needStop == NO) {
                    [self performSelector:@selector(scrollWithSpaceByDirection:) withObject:direction afterDelay:ScrollIntervalTime];
                }else{
                    _isRunning = NO;
                }
            }];
